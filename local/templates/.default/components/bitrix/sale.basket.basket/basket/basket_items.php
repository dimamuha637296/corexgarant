...
//$goods = Add2BasketByProductID(839, 1);
...
/*
 ...
 //*/
//pr( $arResult["GRID"]["HEADERS"]);
?>

    <div id="basket_items_list">
        <div class="bx_ordercart_order_table_container">
            <table id="basket_items" class="table-reset tbi">
                <thead class="tbi-thead">
                <tr>
                    <?
                        ...
                        <tr id="<?= $arItem["ID"] ?>">
                            ...
                            foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
                                        ...
                                        <div class="bx_ordercart_photo_container">
                                            ...
                                            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>">
                                                <div class="bx_ordercart_photo">
                                                    <img src="<?=$url?>" alt="<?=$arItem["NAME"]?>"></div>
                                            </a>
                                                                        ...
                                                                        foreach ($arItem["PROPS"] as $arItemProp):
                                                                            if ($arItemProp["CODE"] == $arItem["SKU_DATA"][$propId]["CODE"]) {
                                                                                if ($arItemProp["VALUE"] == $arSkuValue["NAME"] || $arItemProp["VALUE"] == $arSkuValue["XML_ID"]):
                                                                                    $selected = " bx_active";
                                                                                ?>
                                                                                <li style="width:10%;" class="sku_prop<?= $selected ?>" >
                                                            ...
                                                            <div class="bx_size">
                                                                <ul id="prop_<?= $arProp["CODE"] ?>_<?= $arItem["ID"] ?>"
                                                                    ...
                                                                    <?$flag = false;
                                                                            ...
                                                                            foreach ($arItem["PROPS"] as $arItemProp):
                                                                                if ($arItemProp["CODE"] == $arItem["SKU_DATA"][$propId]["CODE"]) {
                                                                                    if ($arItemProp["VALUE"] == $arSkuValue["NAME"]):
                                                                                        $selected = " bx_active";
                                                                                        $flag = true;
                                                                                        if($arItemProp["CODE"] == 'SIZE'){
                                                                                            $sizeList = explode(';', $arItemProp['VALUE']);
                                                                                            $arSize = array();
                                                                                            foreach($sizeList as $sItem){
                                                                                                switch (substr($sItem, 0, 6)){
                                                                                                    case 'Длина:':
                                                                                                        $arSize['LONG'] = substr($sItem, 6);
                                                                                                        break;
                                                                                                    case 'Ширина':
                                                                                                        $arSize['WIDTH'] = substr($sItem, 7);
                                                                                                        break;
                                                                                                    case 'Высота':
                                                                                                        $arSize['HEIGHT'] = substr($sItem, 7);
                                                                                                        break;
                                                                                                    default:
                                                                                                        $arSize['COMMENT'] = $sItem;
                                                                                                }
                                                                                            }
                                                                                            $arSkuValue["NAME"] = $arSize['LONG'].$arSize['WIDTH'].$arSize['HEIGHT'].$arSize['COMMENT'];
                                                                                        }
                                                                                    ...
                                                                                    ?>
                                                                                            ...
                                                                                            <div class="li_content">
                                                                                                <span class="cnt">
                                                                                                    <span class="size-list">
                                                                                                        <?if(!empty($arSize['WIDTH'])):?>
                                                                                                            <span class="item width">
                                                                                                                <span class="ttl"><?=GetMessage("DB_WIDTH")?></span>
                                                                                                                <span class="num"><?=$arSize['WIDTH'].GetMessage("MILIMETERS")?></span>
                                                                                                            </span><br/>
                                                                                                        <?endif;?>
                                                                                                        <?if(!empty($arSize['LONG'])):?>
                                                                                                            <span class="item length">
                                                                                                                <span class="ttl"><?=GetMessage("DB_LONG")?></span>
                                                                                                                <span class="num"><?=$arSize['LONG'].GetMessage("MILIMETERS")?></span>
                                                                                                            </span><br/>
                                                                                                        <?endif;?>
                                                                                                        <?if(!empty($arSize['HEIGHT'])):?>
                                                                                                            <span class="item height">
                                                                                                                <span class="ttl"><?=GetMessage("DB_HEIGHT")?></span>
                                                                                                                <span class="num"><?=$arSize['HEIGHT'].GetMessage("MILIMETERS")?></span>
                                                                                                            </span><br/>
                                                                                                        <?endif;?>
                                                                                                    </span>
                                                                                                </span>
                                                                                            </div>
                                                                                            <?if(!empty($arSize['COMMENT'])):?>
                                                                                        ...
                                                                                        <?else:?>
                                                                                            <li style="width:10%;" class="sku_prop<?= $selected ?>">
                                                                                                <a disabled="disabled" href="javascript:void(0)" class="cnt"><?= $arSkuValue["NAME"] ?></a>
                                                                                            </li>
                                                                                        <?endif;?>
                                                                                    <?endif;
                                                                                }
                                                                        ...
                                                                        endforeach;
                                                                    if(!$flag):?>
                                                                        <li style="width:10%;" class="sku_prop bx_active">
                                                                            <a disabled="disabled" href="javascript:void(0)" class="cnt"><?=GetMessage("HAS_NO")?></a>
                                                                        </li>
                                                                    <?endif;?>
                                                                </ul>
                                                            </div>
                                ...
                                elseif ($arHeader["id"] == "QUANTITY"):
                                    ?>
                                    <td class="tbi-td custom">
                                        <div class="centered">
                                            <table cellspacing="0" cellpadding="0" class="table-reset counter">
                                                <tr>
                                                    <td>
                                                        <?
                                ...
                                elseif ($arHeader["id"] == "PRICE"):
                                    ...
                                    <td class="tbi-td price priceee">
                                        ...
                                        <div class="old_price" <?/*?> id="old_price_<?= $arItem["ID"] ?>"<?//*/?>>
                                            ...
                                            <?elseif($arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]]):?>
                                                <?=$arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]];?>
                                            <?endif; ?>
                                        </div>
                                ...
                                elseif ($arHeader["id"] == "DISCOUNT"):
                                    ...
                                    <td class="tbi-td custom">
                                       ...
                                       <div <?/*/?>id="discount_value_<?= $arItem["ID"] ?>"<?//*/?>>
                                            <?//pr($arItem);?>
                                           <?if(intval($arItem["DISCOUNT_PRICE_PERCENT_FORMATED"])>0):?>
                                                <?= $arItem["DISCOUNT_PRICE_PERCENT_FORMATED"] ?>
                                           <?elseif(intval($arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]])>$arItem["PRICE"] && $arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]]):?>
                                                <?=round($arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]]*100/$arItem["PRICE"]-100)?>.00%
                                                <?//=round($arItem["PRICE"]/$arResult["SALE_PRICE"][$arItem["PRODUCT_ID"]]*100-100)?>
                                            <?endif;?>
                                       </div>
                                    </td>
                                    <?
                                elseif ($arHeader["id"] == "WEIGHT"):
                                    ...
                                    <td class="tbi-td custom">
                                        ...
                                        if ($arHeader["id"] == "SUM"):
                                        ?>
                                        <div id="sum_<?= $arItem["ID"] ?>"class="total_price  SUMM ">
                                            <?
                                            endif;
        ...
        <div class="bx_ordercart_order_pay">
            ...
            <div class="bx_ordercart_order_pay_left" id="coupons_block">
                ...
                if ($arParams["HIDE_COUPON"] != "Y") {
                    ...
                    <span><?= GetMessage("STB_COUPON_PROMT") ?></span><input class="form-control" type="text" id="coupon" name="COUPON"
            ...
            <div class="bx_ordercart_order_pay_right">
                <table class="bx_ordercart_order_sum no-hover table-reset">
                    ...
                    <? if ($arParams["PRICE_VAT_SHOW_VALUE"] == "Y"):?>
                        ...
                        <tr>
                            ...
                            <td id="allSum_wVAT_FORMATED"><?= $arResult["allSum_wVAT_FORMATED"] ?>222</td>
                        </tr>
                        <?//*/?>
            ...
            <div class="bx_ordercart_order_pay_center item-box">
                <? if ($arParams["BUY_ONE_CLICK"] == "Y"):?>
                    <a href="javascript:void(0)" class=" buy-one-click button btn btn-default" data-toggle="modal" data-target="#buyOneClickForm" data-type="basket">
                        <?= GetMessage("BUY_ONE_CLICK_LABEL") ?>
                    </a>
                <?endif; ?>
                ...
                ?>
                <a href="javascript:void(0)" onclick="checkOut();" class="checkout btn btn-default"><?= GetMessage("SALE_ORDER") ?></a>
            </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align:center; font-size: 20px;">
                    <div class="calibri-r"><?= GetMessage("SALE_NO_ITEMS"); ?></div>
                </td>
            </tr>
            </tbody>
        </table>
