                            ...
                            <div class="buy">
                                <?if($canBuyStatus == 1):?>
                                    ...
                                    ?>
                                        <div class="item_buttons_counter_block catalog-btn-counter">
                                            <a href="javascript:void(0)" class="bx_bt_button_type_2 bx_small bx_fwb btn-down"  data-count-delta="<?=$itemMeasure?>">–</a>
                                            <input type="text" value="<?=$itemMeasure?>" class="tac transparent_input quantity">
                                            <a href="javascript:void(0)" class="bx_bt_button_type_2 bx_small bx_fwb btn-up" data-count-delta="<?=$itemMeasure?>">+</a>
                                        </div>
                                    <?endif;?>
                                    <a href="javascript:void(0)" class="btn btn-default btn-buy"><?=$arParams['BTN_MESS_BUY']?></a>
                                    <?if($arParams['BUY_ONE_CLICK_SECTION'] == 'Y'):?>
                                        <a href="javascript:void(0)" class="lnk-pseudo buy-one-click" data-id="<?=$arItem["ID"]?>" data-type="catalog" data-toggle="modal" data-target="#buyOneClickForm">
                                            <?=$arParams["BTN_MESS_BUY_ONE_KLICK"]?>
                                        </a>
                                    <?endif;?>
                                ...
                                <?if($arParams['~DISPLAY_COMPARE'] == 'Y'):?>
                                    <label class="label_compare">
                                        <input class="formstyler db_compare" type="checkbox"><?=($arParams['NAME_COMPARE_BTN']?$arParams['NAME_COMPARE_BTN']:GetMessage("NAME_COMPARE_BTN"))?>
                                    </label>
                                <?endif;?>
                            </div>
                    </div>
