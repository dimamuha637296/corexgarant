...
if($arParams["DISPLAY_PICTURE"]!="N"){
   // $arParams["TYPE_IMG_THUMB_LIST"] = trim($arParams["TYPE_IMG_THUMB"]);
    ...
    $arParams["BLOCK_IMG_WIDTH"] = intval($arParams["BLOCK_IMG_WIDTH"]) > 0 ? intval($arParams["BLOCK_IMG_WIDTH"]) : '275';
    $arParams["BLOCK_IMG_HEIGHT"] = intval($arParams["BLOCK_IMG_HEIGHT"]) > 0  ? intval($arParams["BLOCK_IMG_HEIGHT"]) : '230';
