...
if($arParams["DISPLAY_PICTURE"]!="N"){
   // $arParams["TYPE_IMG_THUMB_LIST"] = trim($arParams["TYPE_IMG_THUMB"]);
    ...
    $arParams["TABLE_IMG_WIDTH"] = intval($arParams["TABLE_IMG_WIDTH"]) > 0 ? intval($arParams["TABLE_IMG_WIDTH"]) : '100';
    $arParams["TABLE_IMG_HEIGHT"] = intval($arParams["TABLE_IMG_HEIGHT"]) > 0  ? intval($arParams["TABLE_IMG_HEIGHT"]) : '100';
