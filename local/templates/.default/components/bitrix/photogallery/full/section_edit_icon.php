...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"ALBUM_PHOTO_THUMBS_WIDTH"	=>	$arParams["DISPLAY_IMG_SECTION_WIDTH"],
		"ALBUM_PHOTO_WIDTH"	=>	$arParams["DISPLAY_IMG_SECTION_WIDTH"],
		"ALBUM_PHOTO_WIDTH"	=>	$arParams["DISPLAY_IMG_SECTION_HEIGHT"],
