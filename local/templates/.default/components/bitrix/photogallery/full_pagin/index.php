...
$APPLICATION->IncludeComponent(
	"db.base:iblock.section.list",
	"gallery",
	Array(
		"VIEW_MODE" => "LINE",
		"SHOW_PARENT_NAME" => "Y",
		"SECTION_COUNT" => $arParams["SECTION_PAGE_ELEMENTS"],
		...
		"SECTION_USER_FIELDS" => array(0=>"UF_DATE",1=>"UF_DOP_NAME",2=>"",),
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SORT_ORD" => "ASC",//$arParams["SECTION_SORT_ORD"],
		...
		"TYPE_IMG_THUMB" => $arParams["TYPE_IMG_THUMB"],
		"SHARPEN" => $arParams["SHARPEN"],
		"DISPLAY_IMG_SECTION_WIDTH" => intval("229"),
		"DISPLAY_IMG_SECTION_HEIGHT" => intval("165"),
