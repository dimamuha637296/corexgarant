...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	...
	<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>
		...
		<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<input type="submit" class="e-podbor-btn" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
			<input type="hidden" name="action" value="unsubscribe" />
		<?else:?>
			<input type="submit" class="e-podbor-btn" name="activate" value="<?echo GetMessage("subscr_activate")?>" />
