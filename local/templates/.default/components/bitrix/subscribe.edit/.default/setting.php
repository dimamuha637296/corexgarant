...
<tr valign="top">
	<td width="40%">
		<p><?echo GetMessage("subscr_email")?><b class="rq">*</b><br />
		<input type="text" class="text" name="EMAIL" value="<?=$arResult["SUBSCRIPTION"]["EMAIL"]!=""?$arResult["SUBSCRIPTION"]["EMAIL"]:$arResult["REQUEST"]["EMAIL"];?>" size="30" maxlength="255" /></p>
		<p><?echo GetMessage("subscr_rub")?><b class="rq">*</b><br />
...
<tfoot><tr><td colspan="2">
	<input type="submit" class="e-podbor-btn" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
	<input type="reset" class="e-podbor-btn" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
</td></tr></tfoot>
</table>
