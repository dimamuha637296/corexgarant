...
else
{
	...
	<div class="bx_order_list">
		<div class="bx_my_order_switch"><a href="<?= htmlspecialcharsbx($arResult["URL_TO_LIST"]) ?>" class="bx_mo_link"><?=GetMessage("DB_LINK_PREV")?></a></div>
		<div class="table-responsive">
			<table class="bx_order_list_table">
				<thead>
				<tr>
					<th colspan="2"><?= Loc::getMessage('SPOD_LIST_MY_ORDER', array(
				...
				<tbody>
				<tr>
					<td><?= Loc::getMessage('SPOD_LIST_CURRENT_STATUS', array(
						'#DATE_ORDER_CREATE#' => $arResult["DATE_INSERT_FORMATED"]
					)) ?></td>
					<td><?
				...
				<tr>
					<td><?= Loc::getMessage('SPOD_ORDER_PRICE')?>:</td>
					<td><?= $arResult["PRICE_FORMATED"]?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_2")?>:</td>
					<td>Нет&nbsp;&nbsp;&nbsp;[<a href="<?=$arResult["URL_TO_CANCEL"]?>"><?= Loc::getMessage('SPOD_ORDER_CANCEL') ?></a>]</td>
				</tr>
				<tr>
					<td colspan="2"><?=GetMessage("DB_COLUM_1")?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_3")?>:</td>
					<td><?=htmlspecialcharsbx($arResult["USER"]['LOGIN']);?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_4")?>:</td>
					<td><a href="mailto:<?=$arResult['USER']['EMAIL']?>"><?=$arResult['USER']['EMAIL']?></a></td>
				</tr>
				<tr>
					<td colspan="2"><?=GetMessage("DB_COLUM_7")?></td>
				</tr>
				<?foreach($arResult["ORDER_PROPS"] as $arProp):?>
					<?if($arProp["CODE"] != "FIO" &&  $arProp["CODE"] != "EMAIL" ):?>
						<tr>
							<td><?=$arProp["NAME"]?></td>
							<td><?=$arProp["VALUE"]?></td>
						</tr>
				...
				<?endforeach;?>
				<tr>
					<td colspan="2"><?=GetMessage("DB_COLUM_8")?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_5")?>:</td>
					<td><?echo $arResult['USER']['NAME'].' '.$arResult['USER']['LAST_NAME'].' '.$arResult['USER']['SECOND_NAME'];?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_6")?>:</td>
					<td><a href="mailto:<?=$arResult['USER']['EMAIL']?>"><?=$arResult['USER']['EMAIL']?></a></td>
				</tr>

				<tr>
					<td colspan="2"><?=GetMessage("DB_COLUM_9")?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_10")?>:</td>
					<td><?=$arResult['PAYMENT'][0]["PAY_SYSTEM_NAME"];?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_11")?>:</td>
					<td><?=$arResult['PAYMENT'][0]["PAID"]=="Y"?"Да":"Нет";?></td>
				</tr>
				<tr>
					<td><?=GetMessage("DB_COLUM_12")?>:</td>
					<td><?=$arResult['SHIPMENT'][0]["DELIVERY_NAME"];?></td>
				</tr>
				</tbody>
			</table>
		...
		<h3><?=GetMessage("DB_COLUM_13")?></h3>
		<table class="bx_order_list_table_order">
			<thead>
			<tr>
				<th colspan="2"><?=GetMessage("DB_COLUM_14")?></th>
				<th class="custom price"><?=GetMessage("DB_COLUM_15")?></th>
				<th class="custom amount"><?=GetMessage("DB_COLUM_16")?></th>
				<th class="custom price"><?=GetMessage("DB_COLUM_17")?></th>
			</tr>
			<tbody>
			<?
			//pr($arResult['BASKET']);
			...
			<tr>
				<td class="custom img">
					<div class="bx_ordercart_photo_container">
						<a href="<?=$arResult["URL"][$arResult["BASKET"][$item['BASKET_ID']]["PRODUCT_ID"]]?>">
							<div style="background-image:url('<?=$imageSrc?>')" class="bx_ordercart_photo"></div>
						</a>
					</div>
				</td>
				<td class="custom name"><a href="<?=$arResult["URL"][$arResult["BASKET"][$item['BASKET_ID']]["PRODUCT_ID"]]?>" target="_blank"><?=htmlspecialcharsbx($basketItem['NAME'])?></a></td>
				<td class="custom price"><span class="fm">Цена:</span><?=$basketItem['BASE_PRICE_FORMATED']?></td>
				<td class="custom"><span class="fm">Свойства:</span>
					<ul class="list-reset bx_ol_sku_prop">
						<?
						//pr($basketItem['PROPS']);
						foreach ($basketItem['PROPS'] as $itemProps):?>
						<li>
							<nobr><?= htmlspecialcharsbx($itemProps['NAME']) ?>:</nobr>&nbsp;<?= htmlspecialcharsbx($itemProps['VALUE']) ?>
						</li>
						<?endforeach;?>
                        <?if(!empty($basketItem['PROPERTIES'])):
                            foreach ($basketItem['PROPERTIES'] as $key => $arItemProp):
                                if(!empty($arItemProp['VALUE'])):
                        ?>
                                <li>
                                    <nobr><?= htmlspecialcharsbx($arItemProp['NAME']) ?>:</nobr>&nbsp;<?= htmlspecialcharsbx($arItemProp['VALUE']) ?>
                                    <?=(in_array($key, array('WIDTH', 'LONG', 'HEIGHT')) ? GetMessage("B_MM") : '')?>
                                </li>
                                <?endif;?>
                            <?endforeach;?>
                        <?endif;?>
				...
				<td class="custom price"><span class="fm">Количество:</span><?=intval($item['QUANTITY'])?>&nbsp;<?=htmlspecialcharsbx($item['MEASURE_NAME'])?></td>
			</tr>
			<?endforeach;?>

			</tbody>
		</table>
		<table class="table-reset no-hover bx_ordercart_order_sum">
			<?//pr($arResult);?>
				<tbody>
					<?if(intval($arResult["PRICE_DELIVERY_FORMATED"])>0):?>
						<tr>
							<td class="custom_t1">Товаров на:</td>
							<td class="custom_t2"><?=$arResult["PRODUCT_SUM_FORMATED"]?></td>
						</tr>
					<?endif;?>
					<?if(intval($arResult["PRICE_DELIVERY_FORMATED"])>0):?>
						<tr>
							<td class="custom_t1">Стоимость доставки:</td>
		...
		<div class="bx_ordercart_order_pay_center"><a href="<?= htmlspecialcharsbx($arResult["URL_TO_LIST"]) ?>" class="btn btn-default">Вернуться назад</a></div>
	</div>
...
<?/*?>
	<div
		...
		<div class="col-md-12 col-sm-12 col-12 sale-order-detail-general">
			<div class="row">
				<div class="col-md-12 cols-sm-12 col-12 sale-order-detail-general-head">
			...
			<div class="row sale-order-detail-about-order">
				...
				<div class="col-md-12 col-sm-12 col-12 sale-order-detail-about-order-container">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12 sale-order-detail-about-order-title">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12 sale-order-detail-about-order-inner-container">
							<div class="row">
							...
							<div class="col-md-12 col-sm-12 col-12 sale-order-detail-about-order-inner-container-details">
			...
			<div class="row sale-order-detail-payment-options">
				...
				<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-container">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-title">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-inner-container">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-info">
									<div class="row">
										<div class="col-md-1 col-sm-2 col-2 sale-order-detail-payment-options-info-image"></div>
										<div class="col-md-11 col-sm-10 col-10 sale-order-detail-payment-options-info-container">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-methods-container">
									<?
									foreach ($arResult['PAYMENT'] as $payment)
									{
										?>
										<div class="row payment-options-methods-row">
											<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-methods">
												<div class="row sale-order-detail-payment-options-methods-information-block">
													<div class="col-md-2 col-sm-5 col-12 sale-order-detail-payment-options-methods-image-container">
													...
													<div class="col-md-8 col-sm-7 col-10 sale-order-detail-payment-options-methods-info">
													...
													{
														?>
														<div class="col-md-2 col-sm-12 col-12 sale-order-detail-payment-options-methods-button-container">
															<?
													...
													?>
													<div class="sale-order-detail-payment-inner-row-template col-md-offset-3 col-sm-offset-5 col-md-5 col-sm-10 col-12">
												...
												{
													?>
													<div class="row sale-order-detail-payment-options-methods-template col-md-12 col-sm-12 col-12">
														...
														<div class="col-md-9 col-md-offset-3 col-sm-12 sale-order-detail-payment-options-shipment-composition-map">
															...
															<div class="row">
																<div class="col-md-12 col-sm-12 sale-order-detail-payment-options-shipment-composition-container">
																	<div class="row">
																		<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-shipment-composition-title">
																							...
																							<?
																								foreach ($shipment['ITEMS'] as $item)
																								{
																									...
																									<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
																										<div class="sale-order-detail-order-item-td"
																											...
																											<div class="sale-order-detail-order-item-block">
																												...
																												<span class="sale-order-detail-order-item-color-name">
																													<?= htmlspecialcharsbx($itemProps['NAME']) ?>11:</span>
																																	<span class="sale-order-detail-order-item-color-type">222222!!!<?= htmlspecialcharsbx($itemProps['VALUE']) ?></span>
																																</div>
																																<?
																															}
																														}
																										...
																										<div class="sale-order-detail-order-item-nth-4p1"></div>
																										<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
																											<div class="sale-order-detail-order-item-td-title col-7  col-sm-7 col-dm-7 visible-xs visible-sm">
																												<?= Loc::getMessage('SPOD_QUANTITY')?>
																											</div>
			...
			<div class="row sale-order-detail-payment-options-order-content">
				...
				<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-order-content-container">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-12 sale-order-detail-payment-options-order-content-title">
										...
										<div class="sale-order-detail-order-item-table">
											...
											foreach ($arResult['BASKET'] as $basketItem)
											{
												...
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
													...
													<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
														<div class="sale-order-detail-order-item-td-title col-7 col-sm-5 visible-xs visible-sm">
															<?= Loc::getMessage('SPOD_PRICE')?>
														</div>
														<div class="sale-order-detail-order-item-td-text">
													...
													if (strlen($basketItem["DISCOUNT_PRICE_PERCENT_FORMATED"]))
													{
														...
														<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
															...
															<div class="sale-order-detail-order-item-td-text">
																<strong class="bx-price">2<?= $basketItem['DISCOUNT_PRICE_PERCENT_FORMATED'] ?></strong>
															</div>
														</div>
														<?
													}
													...
													<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
														<div class="sale-order-detail-order-item-td-title col-7 col-sm-5 visible-xs visible-sm"><?= Loc::getMessage('SPOD_ORDER_PRICE')?></div>
														<div class="sale-order-detail-order-item-td-text">
			...
			<div class="row sale-order-detail-total-payment">
				<div class="col-md-7 col-md-offset-5 col-sm-12 col-12 sale-order-detail-total-payment-container">
					<div class="row">
						<ul class="col-md-8 col-sm-6 col-6 sale-order-detail-total-payment-list-left">
							<?
						...
						<ul class="col-md-4 col-sm-6 col-6 sale-order-detail-total-payment-list-right">
							<?
							if (floatval($arResult["ORDER_WEIGHT"]))
							{
								?>
