...
?>
<h1><?=($SECTIONS["UF_TITLE"]?$SECTIONS["UF_TITLE"]:$SECTIONS["NAME"])?><?=(intval($arNavigation['PAGEN'])>1?GetMessage("DB_NUMBER_PAGE").$arNavigation['PAGEN']:"")?></h1>
