...
<div class="b-map">
<div class="b-index-map-info _hide" id="map-info-to-show-element_map_<?=$arResult["VARIABLES"]["SECTION_ID"].$arResult["VARIABLES"]["SECTION_CODE"]?>"></div>
<?$APPLICATION->IncludeComponent("db.base:ymap.view", "simple", array(
		'INIT_MAP_TYPE' => 'MAP',
		'INIT_MAP_SCALE' => 15,
		'MAP_WIDTH' => '100%',
		'MAP_HEIGHT' => '400',
		'MAP_ID' => 'element_map_'.$arResult["VARIABLES"]["SECTION_ID"].$arResult["VARIABLES"]["SECTION_CODE"],
		...
		'ICHON_HREF_GRP' => COption::GetOptionString('db.base', "ICHON_HREF_GRP", BX_PERSONAL_ROOT."/templates/html/images/gy_map_icon.png"),
