...
$arParams["DETAIL_POPUP_IMG_WIDTH"] = isset($arParams["DETAIL_POPUP_IMG_WIDTH"]) ? intval($arParams["DETAIL_POPUP_IMG_WIDTH"]) : '100';
$arParams["DETAIL_POPUP_IMG_HEIGHT"] = isset($arParams["DETAIL_POPUP_IMG_HEIGHT"]) ? intval($arParams["DETAIL_POPUP_IMG_HEIGHT"]) : '1000';
$arParams["DETAIL_BIG_IMG_WIDTH"] = isset($arParams["DETAIL_BIG_IMG_WIDTH"]) ? intval($arParams["DETAIL_BIG_IMG_WIDTH"]) : '5000';
$arParams["DETAIL_BIG_IMG_HEIGHT"] = isset($arParams["DETAIL_BIG_IMG_HEIGHT"]) ? intval($arParams["DETAIL_BIG_IMG_HEIGHT"]) : '2500';
$arParams["DETAIL_SMALL_IMG_WIDTH"] = isset($arParams["DETAIL_SMALL_IMG_WIDTH"]) ? intval($arParams["DETAIL_SMALL_IMG_WIDTH"]) : '600';
$arParams["DETAIL_SMALL_IMG_HEIGHT"] = isset($arParams["DETAIL_SMALL_IMG_HEIGHT"]) ? intval($arParams["DETAIL_SMALL_IMG_HEIGHT"]) : '600';
...
if($arParams['DETAIL_BRAND'] == "Y" && $arResult["PROPERTIES"]["BRAND"]["VALUE"]){  ///  BRAND
    $arParams["DETAIL_BRAND_IMG_WIDTH"] = isset($arParams["DETAIL_BRAND_IMG_WIDTH"]) ? intval($arParams["DETAIL_BRAND_IMG_WIDTH"]) : '140';
...
if($og_image["SMALL_IMG"]["src"]){
    $og_image = "http://".$_SERVER["SERVER_NAME"].$og_image["SMALL_IMG"]["src"];
}
unset($arTmpImages);
...
//OG:URL
$og_url = "http://".$_SERVER["SERVER_NAME"].$arResult['DETAIL_PAGE_URL'];
...
$arResult['OG']['MAIL'] = "mailto:?subject=".$og_title."&body=".GetMessage('T_MAIL_BODY')."%0A".$og_url;
...
if($arResult['PROPERTIES']['PDF']['VALUE']){
    $array = array($arResult['PROPERTIES']['PDF']['VALUE']," ");
    $arResult['PROPERTIES']['PDF']['VALUE'] = $array;
    $arResult['MORE_FILES'] = ADBIBlockElement::MORE_FILES($arResult['PROPERTIES']['PDF']);
}
