...
function BX_SetPlacemarks_<?echo $arParams['MAP_ID']?>()
{
    ...
    var imgIconType1 = '<?=SITE_TEMPLATE_PATH?>/images/tmplt/map-mark-1.png';
    var imgIconType2 = '<?=SITE_TEMPLATE_PATH?>/images/tmplt/map-mark-3.png';
    var imgIconType3 = '<?=SITE_TEMPLATE_PATH?>/images/tmplt/map-mark-4.png';
    ...
    $('div.b-contact-info-block').each(function(key, divContener) {
        if ($('span.lnk', divContener).length) {
            ...
            if(imgIcon == 1){
                mapIcon = imgIconType1;
            }else if(imgIcon == 2){
            	mapIcon = imgIconType2;
            }else if(imgIcon == 3){
            	mapIcon = imgIconType3;
            }else{
            	mapIcon = imgIconDef;
            }
