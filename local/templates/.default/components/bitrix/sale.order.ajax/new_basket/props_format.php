	...
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default")
	{
		if (!empty($arSource))
		{
			...
			<div>
				...
				{
					?>
					<div data-property-id-row="<?=intval(intval($arProperties["ID"]))?>" class="form-group">
						...
						if ($arProperties["TYPE"] == "CHECKBOX")
						{
							?>
							<div class="bx_block r1x3 pt8">
								<input class="form-control" type="hidden" name="<?=$arProperties["FIELD_NAME"]?>" value="">
								<input class="form-control" type="checkbox" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" value="Y"<?if ($arProperties["CHECKED"]=="Y") echo " checked";?>>
