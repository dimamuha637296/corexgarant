...
$life_time = 86400*7;
$cache_id = "404ErrorDealers".$arResult["VARIABLES"]["SECTION_CODE"].$arParams['COMPONENT_TEMPLATE'].$arParams['IBLOCK_ID'];
$cache_path = "/dealers_news404_".$arParams['COMPONENT_TEMPLATE'].$arParams['IBLOCK_ID']."/";
